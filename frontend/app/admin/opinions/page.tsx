...
function AdminOpinionsList() {
  ...
  const { data, mutate, isLoading } = useSWR(['admin-opinions', statusFilter, search, isAuthorRole, page], ([_, status, q, mine, p]) => fetchAdminPosts({ contentType: 'OPINION', status: status || undefined, search: q || undefined, sort: 'updated', mine, page: Number(p), limit: 50 }));
