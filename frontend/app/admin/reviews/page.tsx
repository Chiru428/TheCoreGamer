...
export default function AdminReviewsPage() {
  ...
  const { data, mutate, isLoading } = useSWR(['admin-reviews', statusFilter, search, isAuthorRole], ([_, status, q, mine]) => fetchAdminPosts({ contentType: 'REVIEW', status: status || undefined, search: q || undefined, sort: 'updated', mine }));
