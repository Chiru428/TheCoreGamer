...
function AdminReviewsList() {
  ...
  const { data, mutate, isLoading } = useSWR(['admin-reviews', statusFilter, search, isAuthorRole, page], ([_, status, q, mine, p]) => fetchAdminPosts({ contentType: 'REVIEW', status: status || undefined, search: q || undefined, sort: 'updated', mine, page: Number(p), limit: 50 }));
