...
export default function AdminFeaturesPage() {
  ...
  const { data, mutate, isLoading } = useSWR(['admin-reviews', statusFilter, search, isAuthorRole], ([_, status, q, mine]) => fetchAdminPosts({ contentType: 'FEATURE', status: status || undefined, search: q || undefined, sort: 'updated', mine }));
